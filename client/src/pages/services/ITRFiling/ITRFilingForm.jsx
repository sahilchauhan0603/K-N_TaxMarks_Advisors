...
import { useServicePrice, formatPrice } from '../../../utils/servicePricing';
...
const ITRFilingForm = ({ type = 'individual', onClose }) => {
  ...
  // Get pricing for individual or business ITR filing
  const serviceType = form.itrType === 'Business' ? 'filing_business' : 'filing_individual';
  const { price, loading: priceLoading, formattedPrice } = useServicePrice('itr', serviceType);
        ...
        Swal.fire({
          ...
          html: `
            <div class="text-center space-y-3">
              ...
              <p class="text-lg text-gray-700 font-medium">Your ITR request has been submitted successfully!</p>
    ...
    <div className="w-full h-full bg-gradient-to-br from-green-50 to-white">
      ...
      <div className="bg-green-600 text-white p-4 sm:p-6 rounded-t-2xl">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
          <h4 className="text-xl sm:text-2xl font-bold">ITR Filing ({type})</h4>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input 
                ...
                required
                className="w-full border border-green-200 rounded-lg px-4 py-3 focus:ring-2 focus:ring-green-400 focus:border-transparent transition-all uppercase"
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              placeholder="Any additional information for ITR filing..."
            />
          </div>
          ...
          <div className="pt-4">
            <button 
              type="submit" 
              disabled={loading}
              className="w-full cursor-pointer bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white font-bold py-3 px-6 rounded-lg shadow-md transition-all duration-200 transform hover:scale-[1.02] disabled:scale-100 disabled:cursor-not-allowed"
            >
              {loading ? (
