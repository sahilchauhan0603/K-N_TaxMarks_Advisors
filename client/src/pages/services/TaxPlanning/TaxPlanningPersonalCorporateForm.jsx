...
const TaxPlanningPersonalCorporateForm = ({ onClose }) => {
  ...
  const { price, loading: priceLoading, formattedPrice } = useServicePrice('tax', 'personal_corporate');
    ...
    <div className="w-full h-full bg-gradient-to-br from-blue-50 to-white">
      ...
      <div className="bg-blue-600 text-white p-4 sm:p-6 rounded-t-2xl">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
          <h4 className="text-xl sm:text-2xl font-bold">Personal & Corporate Tax</h4>
      ...
      <div className="p-4 sm:p-6 space-y-4 h-[calc(450px-100px)] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input 
                ...
                placeholder="Individual, Company, Partnership, LLP"
              />
            </div>
            <div className="space-y-2">
              <label className="block text-sm font-semibold text-blue-700">
              ...
              <input 
                name="incomeDetails" 
                value={form.incomeDetails} 
                onChange={handleChange} 
                required
                className="w-full border border-blue-200 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all"
                placeholder="Annual income range or specifics"
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-blue-700">
              Upload Tax Documents (Images Only)
            </label>
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              placeholder="Describe your tax planning needs, investment preferences, financial goals, deduction requirements..."
            />
          </div>
