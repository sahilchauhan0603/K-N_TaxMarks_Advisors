  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 bg-gradient-to-br from-blue-50 to-white border-l-4 border-blue-500 rounded-xl p-6 shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm text-blue-700 mb-1">Investment Plans</label>
          <input name="investmentPlans" value={form.investmentPlans} onChange={handleChange} className="w-full border border-blue-200 rounded px-3 py-2 focus:ring-2 focus:ring-blue-400" />
        </div>
        <div>
          <label className="block text-sm text-blue-700 mb-1">Year Goals</label>
          <input name="yearGoals" value={form.yearGoals} onChange={handleChange} className="w-full border border-blue-200 rounded px-3 py-2 focus:ring-2 focus:ring-blue-400" />
        </div>
      </div>
      <div className="mt-4">
