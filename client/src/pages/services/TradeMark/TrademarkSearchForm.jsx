...
const TrademarkSearchForm = ({ onClose }) => {
  ...
  const { price, loading: priceLoading, formattedPrice } = useServicePrice('trademark', 'search');
    ...
    <div className="w-full h-full bg-gradient-to-br from-purple-50 to-white">
      ...
      <div className="bg-purple-600 text-white p-4 sm:p-6 rounded-t-2xl">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
          <h4 className="text-xl sm:text-2xl font-bold">Trademark Search & Registration</h4>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <label className="block text-sm font-semibold text-purple-700">
              Brand/Trademark Name <span className="text-red-500">*</span>
            </label>
            <input 
              name="brandName" 
              ...
              placeholder="Enter the brand or trademark name to search"
            />
          </div>
          ...
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-purple-700">
              Upload Logo/Brand Images (Images Only)
            </label>
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              placeholder="Describe your trademark search requirements, business category, etc..."
            />
          </div>
          ...
          <div className="pt-4">
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-purple-400 text-white font-bold py-3 px-6 rounded-lg shadow-md transition-all duration-200 transform hover:scale-[1.02] disabled:scale-100 disabled:cursor-not-allowed"
            >
              {loading ? (
                ...
                'Submit Trademark Search Request'
              )}
            </button>
          </div>
        </form>
