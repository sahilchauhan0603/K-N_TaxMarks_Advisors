...
const TrademarkProtectionForm = ({ onClose }) => {
  ...
  const { price, loading: priceLoading, formattedPrice } = useServicePrice('trademark', 'protection');
    ...
    <div className="w-full h-full bg-gradient-to-br from-purple-50 to-white">
      ...
      <div className="bg-purple-600 text-white p-4 sm:p-6 rounded-t-2xl">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
          <h4 className="text-xl sm:text-2xl font-bold">IP Protection & Dispute Resolution</h4>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              placeholder="e.g., Trademark Infringement, Copyright Dispute, Patent Protection"
            />
          </div>
          ...
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-purple-700">
              Upload Evidence Documents (Images Only)
            </label>
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              placeholder="Describe your IP protection needs, dispute details, timeline requirements, etc..."
            />
          </div>
