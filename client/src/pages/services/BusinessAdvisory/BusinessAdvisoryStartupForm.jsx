...
const BusinessAdvisoryStartupForm = ({ onClose }) => {
  const { user } = useAuth();
  ...
  const { price, loading: priceLoading, formattedPrice } = useServicePrice('business', 'startup');
    ...
    <div className="w-full h-full bg-gradient-to-br from-pink-50 to-white">
      ...
      <div className="bg-pink-600 text-white p-4 sm:p-6 rounded-t-2xl">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
          <h4 className="text-xl sm:text-2xl font-bold">Startup & MSME Registration</h4>
