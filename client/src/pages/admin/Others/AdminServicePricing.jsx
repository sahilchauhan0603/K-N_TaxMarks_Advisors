      ...
      Swal.fire({
        ...
        footer:
          err.response?.status === 401 || err.response?.status === 403
            ? '<a href="/admin/login">Click here to login as admin</a>'
            : null,
      });
    } finally {
      setSaving(false);
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            The pricing system needs to be initialized with default service
            data.
          </p>
          <button
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Manage and update pricing for all services
              </p>
            </div>
            <button
              onClick={fetchServicePricing}
            ...
            ([categoryKey, categoryServices]) => (
              <div
                ...
                className={`bg-white rounded-xl shadow-sm border-2 overflow-hidden ${
                  categoryColors[categoryKey] || "bg-gray-50 border-gray-200"
                }`}
              >
                {/* Category Header */}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-lg font-bold text-gray-900">
                        ...
                        -{" "}
                        {formatPrice(
                          Math.max(...categoryServices.map((s) => s.price))
                        )}
                      </p>
                    </div>
                  </div>
                            ...
                            <div className="flex items-center space-x-2">
                              {editingService === service._id ? (
                                ...
                                <button
                                  ...
                                  title={
                                    !isAdminAuthenticated()
                                      ? "Admin login required to edit prices"
                                      : "Edit Price"
                                  }
                                >
                                  <FaEdit />
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-blue-800 space-y-1">
                <p>
                  • Click the edit button to modify service prices in real-time
                </p>
                <p>• All prices are displayed in Indian Rupees (₹)</p>
                <p>
                  • Updated prices are immediately applied to new service forms
                </p>
                <p>
                  • Prices are automatically applied when admins complete
                  services
                </p>
                <p>
                  • Custom amounts can still be set during service completion if
                  needed
                </p>
                <p>
                  • Bills are generated automatically with 72-hour payment terms
                </p>
              </div>
            </div>
          </div>
