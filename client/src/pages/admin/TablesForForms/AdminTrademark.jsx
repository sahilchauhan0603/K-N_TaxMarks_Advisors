...
const subTabs = [
  {
    key: "search",
    label: "Trademark Search & Registration",
    endpoint: "/api/trademark-search",
  },
  {
    key: "documentation",
    label: "Legal Documentation & Compliance",
    endpoint: "/api/trademark-documentation",
  },
  {
    key: "protection",
    label: "IP Protection & Dispute Resolution",
    endpoint: "/api/trademark-protection",
  },
];
...
// Dispute type options for dropdown
...
const AdminTrademark = () => {
  ...
  const filteredData = data
    ...
    .filter((row) => {
      ...
      if (activeTab === "search" && row.brandName)
        return row.brandName === filter;
      if (activeTab === "documentation" && row.docType)
        return row.docType === filter;
      if (activeTab === "protection" && row.disputeType)
        return row.disputeType === filter;
      return true;
    });
  ...
  return (
    <div className="p-2 bg-gray-50 min-h-screen">
      <div className="max-w-[960px] mx-auto">
          ...
          {subTabs.map((tab) => (
            <button
              ...
              className={`px-5 py-3 rounded-t-lg font-medium transition-all ${
                activeTab === tab.key
                  ? "bg-white border-t border-l border-r border-gray-200 text-purple-600 shadow-sm relative"
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 mb-6 border w-full border-gray-100">
          <div className="flex flex-col md:flex-row gap-4 items-center">
            <div className="relative flex-grow">
              ...
              <input
                ...
                className="pl-10 w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-200 focus:border-purple-400"
              />
            </div>
            ...
            {activeTab === "search" && (
              <div className="w-full md:w-56">
                <input
                  ...
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-200 focus:border-purple-400"
                />
              </div>
            )}
