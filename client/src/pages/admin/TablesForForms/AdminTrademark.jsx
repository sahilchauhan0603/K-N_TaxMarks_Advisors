  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold mb-2 text-gray-800">Trademark Service Requests</h2>
        <p className="text-gray-600 mb-6">Manage and review all trademark service requests</p>
                        ...
                        {columns[activeTab].map(col => (
                          ...
                          >
                            {col === 'createdAt' ? (
                              ...
                              <a href={`mailto:${row[col]}`} className="text-purple-600 hover:text-purple-800">
                                {row[col] || '-'}
                              </a>
                            ) : col === 'mobile' ? (
