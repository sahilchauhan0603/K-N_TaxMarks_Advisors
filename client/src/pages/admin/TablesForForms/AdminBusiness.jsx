...
const subTabs = [
  {
    key: "startup",
    label: "Startup & MSME Registration",
    endpoint: "/api/business-startup",
  },
  {
    key: "incorporation",
    label: "Company Incorporation",
    endpoint: "/api/business-incorporation",
  },
  {
    key: "advisory",
    label: "Legal & Financial Advisory",
    endpoint: "/api/business-advisory",
  },
];
...
const columns = {
  ...
  advisory: ["user", "query", "notes", "documents", "createdAt"],
};
...
const AdminBusiness = () => {
  ...
  const filteredData = data
    ...
    .filter((row) => {
      ...
      if (activeTab === "startup" && row.businessType)
        return row.businessType === filter;
      if (activeTab === "incorporation" && row.companyType)
  ...
  const handleViewDocument = (row) => {
    if (row.documentUrl) {
      setImageModal({
        ...
        title: `Business Document - ${row.userId?.name || "Unknown"}`,
      });
    }
  };
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Manage and review all business service requests
            </p>
          </div>
          <button
                        ...
                        <th
                          ...
                          className={`px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-300 ${
                            col === "user"
                              ...
                              ? "w-48"
                              : col === "businessType" || col === "companyType"
                              ? "w-36"
                              : col === "query" || col === "notes"
                              ? "w-64"
                              : col === "documentPath"
                                ...
                                {col === "user" ? (
                                  ...
                                  row.documentUrl ? (
                                    <button
                                      ...
                                      className="text-pink-600 hover:text-pink-800 cursor-pointer flex items-center gap-1 truncate"
                                    >
                                      <svg
