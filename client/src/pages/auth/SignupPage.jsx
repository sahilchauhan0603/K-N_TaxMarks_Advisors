...
const SignupPage = () => {
  ...
  useEffect(() => {
    const handleBeforeUnload = (e) => {
      if (hasFormData && !isRedirecting) {
        e.preventDefault();
        e.returnValue =
          "Your registration details might get lost. Are you sure you want to reload?";
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-50 via-blue-100 to-purple-100 relative overflow-hidden">
        {/* Decorative Elements */}
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000"></div>
          <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center items-center px-8 py-6 text-gray-800 w-full">
          ...
          {/* Illustration - User Registration */}
          <div className="mb-4">
            <svg
              className="w-48 h-48"
              viewBox="0 0 400 400"
            ...
            >
              ...
              />
              {/* Person icon */}
              <circle cx="200" cy="160" r="40" fill="#6366F1" fillOpacity="0.9" />
              <path
                d="M140 280 Q140 220 200 220 Q260 220 260 280 L260 300 L140 300 Z"
                fill="#6366F1"
                fillOpacity="0.9"
              />
              {/* Checkmarks */}
              <circle cx="280" cy="140" r="20" fill="#10B981" />
              <path
                d="M272 140 L278 146 L288 134"
                stroke="white"
                strokeWidth="3"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <circle cx="280" cy="200" r="20" fill="#10B981" />
              <path
                d="M272 200 L278 206 L288 194"
                stroke="white"
                strokeWidth="3"
                strokeLinecap="round"
                strokeLinejoin="round"
              />
              <circle cx="280" cy="260" r="20" fill="#10B981" />
              <path
                d="M272 260 L278 266 L288 254"
                stroke="white"
                strokeWidth="3"
                strokeLinecap="round"
                strokeLinejoin="round"
          ...
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-3">
              Create your account and get access to expert tax consulting,
              seamless filing services, and personalized financial advice.
            </p>
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="bg-white/70 backdrop-blur-sm rounded-lg p-2 border border-indigo-200 shadow-sm">
                <div className="text-xl font-bold text-indigo-600">{stats.totalClients}+</div>
                <div className="text-gray-600 text-[10px]">Happy Clients</div>
              </div>
              <div className="bg-white/70 backdrop-blur-sm rounded-lg p-2 border border-indigo-200 shadow-sm">
                <div className="text-xl font-bold text-indigo-600">{stats.satisfactionRate}%</div>
                <div className="text-gray-600 text-[10px]">Satisfaction</div>
              </div>
            </div>
          </div>
        </div>
