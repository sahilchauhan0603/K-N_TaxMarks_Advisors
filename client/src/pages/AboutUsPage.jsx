        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
            <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center w-full md:w-1/2">
              <div className="w-32 h-32 rounded-full bg-blue-100 flex items-center justify-center mb-4 border-4 border-blue-200">
                <svg
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 flex flex-col items-center w-full md:w-1/2">
              ...
              <div className="w-32 h-32 rounded-full bg-green-100 flex items-center justify-center mb-4 border-4 border-green-200">
                <svg
